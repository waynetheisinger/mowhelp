...
require get_template_directory() . '/includes/faq.php';

require get_template_directory() . '/includes/category.php';

function override_style() {
  
	wp_enqueue_style( 'sb-styles', get_template_directory_uri() . '/assets/css/override.css');
	
	wp_enqueue_script( 'sb-jquery', get_template_directory_uri() . '/assets/js/jquery.js' );
		
	wp_enqueue_script( 'sb-script', get_template_directory_uri() . '/assets/js/itjl.js' );
}
add_action( 'wp_enqueue_scripts', 'override_style' );
