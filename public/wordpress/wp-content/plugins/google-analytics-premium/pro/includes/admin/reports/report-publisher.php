...
final class MonsterInsights_Report_Publisher extends MonsterInsights_Report {
	...
	protected function get_report_html( $data = array() ) {
		...
		$this->get_landingpages( $data );
		$this->get_exitpages( $data );
		?>

		<div class="monsterinsights-reports-2-column-container row">
			<div class="monsterinsights-reports-2-column-item col-md-6">
				<?php $this->get_outboundlinks( $data ); ?>
			</div>
			<div class="monsterinsights-reports-2-column-item col-md-6">
				<?php $this->get_affiliatelinks( $data ); ?>
			</div>
		</div>

		<?php
		$this->get_downloadlinks( $data );
		?>
	...
	public function get_landingpages( $data ) {
		?>
		<div class="monsterinsights-reports-1-column-row panel row container-fluid nopadding list-no-icons" style="position: relative;">
			<div class="monsterinsights-reports-panel-title">
			...
			<div class="monsterinsights-reports-list">
				<table id="monsterinsights-report-landing-page-list" class="table monsterinsights-reports-data-table">
					<thead class="monsterinsights-reports-data-table-thead">
					<tr>
						<th><?php echo esc_html__( 'Page Titles', 'ga-premium' ); ?></th>
					...
					if ( ! empty( $data['landingpages'] ) ) {
						...
						<tr class="monsterinsights-reports-data-table-tr monsterinsights-listing-table-row">
							<td colspan="4"><?php echo esc_html__( 'No landing pages tracked during this time period', 'ga-premium' ); ?></td>
						</tr>
					<?php }
					?>
					</tbody>
			...
			<div class="monsterinsights-reports-panel-footer monsterinsights-reports-panel-footer-large">
				...
				<div class="monsterinsights-reports-show-selector-group btn-group" role="group" aria-label="<?php echo esc_html__( 'How many to show', 'ga-premium' ); ?>">
					<button type="button" data-tid="monsterinsights-report-landing-page-list" class="monsterinsights-reports-show-selector-button ten btn btn-default active" disabled="disabled">
						10
					</button>
					<button type="button" data-tid="monsterinsights-report-landing-page-list" class="monsterinsights-reports-show-selector-button twentyfive btn btn-default">
						25
					</button>
					<button type="button" data-tid="monsterinsights-report-landing-page-list" class="monsterinsights-reports-show-selector-button fifty btn btn-default">
						50
					</button>
				</div>
	...
	public function get_exitpages( $data ) {
		?>
		<div class="monsterinsights-reports-1-column-row panel row container-fluid nopadding list-no-icons" style="position: relative;">
			<div class="monsterinsights-reports-panel-title">
			...
			<div class="monsterinsights-reports-list">
				<table id="monsterinsights-report-exit-page-list" class="table monsterinsights-reports-data-table">
					...
					if ( ! empty( $data['exitpages'] ) ) {
						...
						<tr class="monsterinsights-reports-data-table-tr monsterinsights-listing-table-row">
							<td colspan="4"><?php echo esc_html__( 'No exit pages tracked during this time period', 'ga-premium' ); ?></td>
						</tr>
					<?php }
					?>
					</tbody>
			...
			<div class="monsterinsights-reports-panel-footer monsterinsights-reports-panel-footer-large">
				<?php echo esc_html__( 'Show', 'ga-premium' ); ?>&nbsp;
				<div class="monsterinsights-reports-show-selector-group btn-group" role="group" aria-label="<?php echo esc_html__( 'How many to show', 'ga-premium' ); ?>">
					<button type="button" data-tid="monsterinsights-report-exit-page-list" class="monsterinsights-reports-show-selector-button ten btn btn-default active" disabled="disabled">
						10
					</button>
					<button type="button" data-tid="monsterinsights-report-exit-page-list" class="monsterinsights-reports-show-selector-button twentyfive btn btn-default">
						25
					</button>
					<button type="button" data-tid="monsterinsights-report-exit-page-list" class="monsterinsights-reports-show-selector-button fifty btn btn-default">
						50
					</button>
				</div>
	...
	public function get_outboundlinks( $data ) {
		?>
	...
	public function get_affiliatelinks( $data ) {
		?>
		<div class="monsterinsights-reports-2-column-panel monsterinsights-white-bg-panel panel nopadding list-no-icons">
			<div class="monsterinsights-reports-panel-title">
	...
	public function get_downloadlinks( $data ) {
		?>
		<div class="monsterinsights-reports-1-column-row panel row container-fluid nopadding list-no-icons" style="position: relative;">
			<div class="monsterinsights-reports-panel-title">
