...
/*
  ...
  License: GPL2
  Copyleft 2009-2022  Miguel Angel Useche Castro (email : migueluseche@skatox.com)
...
if ( ! defined( 'JAL_VERSION' ) ) {
	define( 'JAL_VERSION', '5.0.1' );
}

require_once( 'admin/class-jaw-walker-category-checklist.php' );
require_once( 'classes/class-js-archive-list-settings.php' );
require_once( 'classes/class-js-archive-list-frontend.php' );
require_once( 'classes/class-js-archive-list-backend.php' );
...
function jalw_create_widget_block() {
	register_block_type( __DIR__, [
		'render_callback' => [ 'JQ_Archive_List_Block', 'build_html' ]
	] );
