		...
		$( 'div.activity' ).on( 'click', function( event ) {
			...
			if ( target.attr('name') == 'ac_form_submit' ) {
				...
				$.ajax({
					type: "POST",
					url: ajaxurl,
					data: { action: 'cptch_buddypress_comment_validate', cptch_number : cptch_number, cptch_result : cptch_result, cptch_code : cptch_code, cptch_key : cptch_key, cptch_time : cptch_time, cptch_form : 'buddypress_comments' },
